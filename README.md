...
SmartEats is a production style microservices platform that shows how a modern foodd elivery system is designed, deployed, and operated on AWS using Kubernetes and GitOps.
